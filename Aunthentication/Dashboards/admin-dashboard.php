...
try {
    ...
    if (isset($_POST['delete_client'])) {
        $id = $_POST['client_id'];
        $deleteStmt = $pdo->prepare("DELETE FROM client_profiles WHERE id = ?");
    ...
    if (isset($_POST['update_client'])) {
        ...
        $updateStmt = $pdo->prepare("
            UPDATE client_profiles SET
                name=?, age=?, skintone=?, skin_condition=?, suffering_from=?,
                goals=?, gender=?, condition_start=?, taken_meds=?,
                products_used=?, blood_group=? WHERE id=?
        ");
        $updateStmt->execute([
            $_POST['name'], $_POST['age'], $_POST['skintone'], $_POST['skin_condition'],
            $_POST['suffering_from'], $_POST['goals'], $_POST['gender'], $_POST['condition_start'],
            $_POST['taken_meds'], $_POST['products_used'], $_POST['blood_group'], $id
        ]);
    ...
    $clients = $pdo->query("SELECT * FROM client_profiles ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
...
<body>
    <div class="dashboard">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-item"><a class="nav-link text-white <?= ($currentPage=='clients'?'fw-bold':'') ?>" href="admin-dashboard.php?page=clients"><i class="fas fa-users"></i> Clients</a></li>
    ...
    <table class="table table-bordered table-striped">
        <thead class="table-dark">
            <tr>
                <th>ID</th><th>Name</th><th>Age</th><th>Skin Tone</th><th>Skin Condition</th>
                <th>Suffering From</th><th>Goals</th><th>Gender</th><th>Condition Start</th>
                <th>Taken Meds</th><th>Products Used</th><th>Blood Group</th>
            </tr>
        </thead>
        <tbody>
        <?php foreach ($clients as $client): ?>
            <tr>
                ...
                <td><?= $client['name'] ?></td>
                <td><?= $client['age'] ?></td>
                <td><?= $client['skintone'] ?></td>
                <td><?= $client['skin_condition'] ?></td>
                <td><?= $client['suffering_from'] ?></td>
                <td><?= $client['goals'] ?></td>
                <td><?= $client['gender'] ?></td>
                <td><?= $client['condition_start'] ?></td>
                <td><?= $client['taken_meds'] ?></td>
                <td><?= $client['products_used'] ?></td>
